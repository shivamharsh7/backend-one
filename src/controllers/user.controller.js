...
const refreshAccessToken = asyncHandler(async(req,res)=>{
    ...
    const {accessToken, refreshToken} = await generateAccessAndRefereshTokens(user._id)
    console.log('acc',accessToken,'refre',refreshToken)
...
const changeCurrentPassword = asyncHandler(async(req,res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,{ user},"password is change"))
})
...
const updateAccoountDeatils = asyncHandler(async(req,res)=>{
    ...
    .json(new ApiResponse(
        200,
        user,
        "Accounts deatails updated successfully"
    ))
}) 
...
export {registerUser, getUser,loginUser,logoutUser,refreshAccessToken, changeCurrentPassword, getCurrentUser
    ,updateAccoountDeatils, updateUserAvatar, updateUserCoverImage, getUserChannelProfile} 